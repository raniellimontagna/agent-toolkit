...
Resolve command examples relative to this skill directory. If the shell is not
currently inside the installed `ui-ux-pro-max` folder, use the absolute path to
`scripts/search.py`.
